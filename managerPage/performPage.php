    ...
    <div class="row flex-nowrap">
      ...
      <div class="col py-4 px-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
          ...
          <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#rateModal" <?php echo !$isRatingPeriodActive ? 'disabled' : ''; ?>>
            <i class="fas fa-star me-1"></i> 
            <?php echo $isRatingPeriodActive ? 'Start Rating Others' : 'Rating Closed'; ?>
          </button>
        </div>
