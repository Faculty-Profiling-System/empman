...
<div class="sidebar bg-dark min-vh-100">
        <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-3 text-white">
          ...
          <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start w-100" id="menu">
            ...
            <li class="w-100">
              <a href="emploPage.php" class="nav-link px-3 <?php echo ($currentPage == 'emploPage.php') ? 'active bg-primary' : 'text-white'; ?>">
                  <i class="fas fa-tachometer-alt me-2"></i> Employees
            ...
            <li class="w-100">
              <a href="leaveReqPage.php" class="nav-link px-3 <?php echo ($currentPage == 'leaveReqPage.php') ? 'active bg-primary' : 'text-white'; ?>">
                  <i class="fas fa-tachometer-alt me-2"></i> Leave Requests
            ...
            <li class="w-100">
              <a href="resignPage.php" class="nav-link px-3 <?php echo ($currentPage == 'resignPage.php') ? 'active bg-primary' : 'text-white'; ?>">
                  <i class="fas fa-tachometer-alt me-2"></i> Resignations
                  <?php if($currentPage == 'resignPage.php') echo '<span class="status-dot"></span>'; ?>
              </a>
            </li>
            <li class="w-100">
              <a href="newEmpPage.php" class="nav-link px-3 <?php echo ($currentPage == 'newEmpPage.php') ? 'active bg-primary' : 'text-white'; ?>">
                  <i class="fas fa-tachometer-alt me-2"></i> New Employee
